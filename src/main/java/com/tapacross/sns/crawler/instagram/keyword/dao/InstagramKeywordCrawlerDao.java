...
//
//@Repository
//public class InstagramKeywordCrawlerDao implements IInstagramKeywordCrawlerDao {
...
//	@SuppressWarnings("unchecked")
//	@Override
//	public List<TBCrawlSite2> selectUsersBySiteName(String userName)
//			throws DataAccessException {
//		Session session = hibernateTemplate.getSessionFactory().openSession();
//		try {
//			return session.createCriteria(TBCrawlSite2.class)
//					.add(Restrictions.eq("siteType", "I"))
//					.add(Restrictions.eq("siteName", userName))
//					.addOrder(Order.desc("siteId"))
//					.list();
//		} finally {
//			session.close();
//		}
